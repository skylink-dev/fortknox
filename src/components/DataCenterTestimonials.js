// components/DataCenterTestimonials.js
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="relative p-8 h-full flex flex-col">
                <FaQuoteLeft className="text-3xl opacity-30 mb-6" />
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="p-8 md:p-10 bg-gradient-to-r from-gray-900 to-gray-800 text-white">
            <h3 className="text-2xl md:text-3xl font-bold mb-2">Success Stories</h3>
            <p className="text-gray-300 max-w-2xl">Explore how we've helped companies solve complex infrastructure challenges</p>
          </div>
              ...
              >
                <div className="flex flex-col h-full">
                  ...
                  <motion.a
                    href={caseStudy.link}
                    whileHover={{ x: 5 }}
                    className="mt-auto inline-flex items-center text-blue-600 font-medium group-hover:text-blue-800 transition-colors"
                  >
